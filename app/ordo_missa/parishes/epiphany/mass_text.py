...
def generate_mass_text(num_deacons: int) -> str:
    if num_deacons == 0:
        return "The priest reads the Gospel at Epiphany."
    elif num_deacons == 1:
        return "The deacon reads the Gospel at Epiphany."
    elif num_deacons == 2:
        return "The deacon of the Word reads the Gospel at Epiphany."
    else:
